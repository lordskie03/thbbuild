     ...
     for($y = $startdate; $y <= $enddate; $y = date('Y-m-d', strtotime("+1 day", strtotime($y))))
        {
            ...
            if($y==$enddate)
            {
            array_push($nativedate, date('Y-m-d', strtotime("+1 day", strtotime($y))));
            array_push($nativedate, date('Y-m-d', strtotime("+2 day", strtotime($y))));
            }
...
<div class="upper-menu-filter">
    <form class="filter-form" action="slacksheet" method="get">
        <select name="location" id="location" placeholder="Location">

            <?php   if($_SESSION["account_type"] == "Admin" || $_SESSION["account_type"] == "Manager-Canton") { ?> <option value="Canton" <?php if ($location == "Canton") {
                echo "selected";
            } ?>>Canton</option><?php } ?>
            <?php if($_SESSION["account_type"] == "Admin" || $_SESSION["account_type"] == "Manager-Charles Village") { ?>  <option value="Charles Village" <?php if ($location == "Charles Village") {
                echo "selected";
            } ?>>Charles Village</option><?php } ?>
            <?php if($_SESSION["account_type"] == "Admin" || $_SESSION["account_type"] == "Manager-Columbia") { ?>   <option value="Columbia" <?php if ($location == "Columbia") {
                echo "selected";
            } ?>>Columbia</option><?php } ?>
            <?php if($_SESSION["account_type"] == "Admin" || $_SESSION["account_type"] == "Manager-Owings Mills") { ?>  <option value="Owings Mills" <?php if ($location == "Owings Mills") {
                echo "selected";
            } ?>>Owings Mills</option><?php } ?>
            <?php if($_SESSION["account_type"] == "Admin" || $_SESSION["account_type"] == "Manager-Timonium") { ?>  <option value="Timonium" <?php if ($location == "Timonium") {
                echo "selected";
            } ?>>Timonium</option><?php } ?>
            <?php if($_SESSION["account_type"] == "Admin" || $_SESSION["account_type"] == "Manager-Towson") { ?> <option value="Towson" <?php if ($location == "Towson") {
                echo "selected";
            } ?>>Towson</option><?php } ?>
        </select>
    ...
    <div class="Projection-Day" id="Projection-Day">
        ...
        <div class="Projection-Day-Cell" id="Projection-Day-Cell-Item">
         <table class="slacktable">
             ...
             <tr>
                 <td></td>
                 <td><table class="slacktableinner">
                     <tr>
             ...
             <td><table class="slacktableinner">
                    ...
                    $plainquery = "SELECT * FROM daily_projection WHERE DATE between '{$nativedate[$r]}' and '{$nativedate[$r+2]}'";
                    $slackplain = mysqli_query($dbconnect, $plainquery);
                         $plain = array();

                    while($row2 = mysqli_fetch_assoc($slackplain))
                    {
                             array_push($plain, round($row2["uPlain"] * ($row2["Projected_Sales"] / 10000) * $row2["Projected_Variation"] + $row2["Plain"]));

                           }
                     ?>
                        
                         <td> <?php  echo $plain[0]+$plain[1]+$plain[2]; 
              ...
              <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, round($row3["uPlain"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Plain"]));

                         } ?>

                         <td>
                             <?php echo $plain[0] + $plain[1] + $plain[2];
                             $r++;
                             unset($plain); ?>
                         </td>
                     <td></td>
                 ...
                 <td><b>Wheat</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uWheat"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Wheat"]);
                 ...
                 <td><b>Marble</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uMarble"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Marble"]);
                 ...
                 <td><b>Asiago</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uAsiago"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Asiago"]);
                 ...
                 <td><b>Egg</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uEgg"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Egg"]);
                 ...
                 <td><b>Raisin</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uRaisin"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Raisin"]);
                 ...
                 <td><b>Blueberry</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                       ...
                       while ($row3 = mysqli_fetch_assoc($slackplain)) {
                           array_push($plain, $row3["uBlueberry"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Blueberry"]);
                 ...
                 <td><b>Choc-Chip</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uChoc"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["Choc"]);
                 ...
                 <td><b>LTO</b></td>
                  <td><table class="slacktableinner">
                     <tr>
                         ...
                         while ($row3 = mysqli_fetch_assoc($slackplain)) {
                             array_push($plain, $row3["uLTO_1"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["LTO_1"]);
                     ...
                     <td>
                         <table class="slacktableinner">
                             <tr>
                                 ...
                                 while ($row3 = mysqli_fetch_assoc($slackplain)) {
                                     array_push($plain, $row3["uLTO_2"] * ($row3["Projected_Sales"] / 10000) * $row3["Projected_Variation"] + $row3["LTO_2"]);
